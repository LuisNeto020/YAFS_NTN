...
import math
from placements.placement_sats_and_terrestrials import CloudCentricPlacement
from populations.population_sats_and_terrestrial import EvolPop
...
def run_simulation(folder_results):
    ...
    t.G.add_node("node10762139299", type="STATIC", pos=(41.7803249, -8.2696795), IPT=2500, RAM=8000)
    t.G.add_node("node11609974323", type="STATIC", pos=(41.767395, -8.240963), IPT=2500, RAM=8000)
    t.G.add_node("node10762139300", type="STATIC", pos=(41.7483988, -8.2289958), IPT=2500, RAM=8000)
    t.G.add_node("node9606132852",  type="STATIC", pos=(41.7481369, -8.2005327), IPT=2500, RAM=8000)
    t.G.add_node("node11586863472", type="STATIC", pos=(41.743385, -8.279699), IPT=2500, RAM=8000)
    t.G.add_node("node7302204030",  type="STATIC", pos=(41.7273495, -8.3025206), IPT=2500, RAM=8000)
    t.G.add_node("node10247269222", type="STATIC", pos=(41.6958616, -8.246854), IPT=2500, RAM=8000)
    t.G.add_node("node10767267430", type="STATIC", pos=(41.6582126, -8.3022389), IPT=2500, RAM=8000)
    t.G.add_node("node9677655121",  type="STATIC", pos=(41.6714192, -8.1599611), IPT=2500, RAM=8000)
    t.G.add_node("node12943752612", type="STATIC", pos=(41.6982319, -8.1288032), IPT=2500, RAM=8000)
    t.G.add_node("node9676977102",  type="STATIC", pos=(41.6982919, -8.1005435), IPT=2500, RAM=8000)
    t.G.add_node("node9676977103",  type="STATIC", pos=(41.6833651, -8.0554837), IPT=2500, RAM=8000)
    t.G.add_node("node12191545276", type="STATIC", pos=(41.7149995, -8.0307287), IPT=2500, RAM=8000)
    t.G.add_node("node3810713697",  type="STATIC", pos=(41.6936492, -7.9771511), IPT=2500, RAM=8000)
    t.G.add_node("node9676977104",  type="STATIC", pos=(41.6739596, -8.0024524), IPT=2500, RAM=8000)
    t.G.add_node("node10281233974", type="STATIC", pos=(41.6640746, -7.8994194), IPT=2500, RAM=8000)
    t.G.add_node("node9677461511",  type="STATIC", pos=(41.7427314, -7.8721815), IPT=2500, RAM=8000)
    t.G.add_node("node9631463963",  type="STATIC", pos=(41.7799282, -7.8055146), IPT=2500, RAM=8000)
    t.G.add_node("node10762139303", type="STATIC", pos=(41.8289978, -7.8493854), IPT=2500, RAM=8000)
    t.G.add_node("node9633847528",  type="STATIC", pos=(41.71778, -8.1637729), IPT=2500, RAM=8000)
    t.G.add_node("node9634402357",  type="STATIC", pos=(41.7258847, -8.1646876), IPT=2500, RAM=8000)
    t.G.add_node("node3091549588",  type="STATIC", pos=(41.8129999, -8.1949169), IPT=2500, RAM=8000)
    t.G.add_node("node10082448941", type="STATIC", pos=(41.7495991, -7.9583519), IPT=2500, RAM=8000)
    t.G.add_node("node9499514917",  type="STATIC", pos=(41.7401386, -7.9481038), IPT=2500, RAM=8000)
    t.G.add_node("node10253004472", type="STATIC", pos=(41.8381797, -7.946983), IPT=2500, RAM=8000)
    t.G.add_node("node12583031276", type="STATIC", pos=(41.792778, -7.887053), IPT=2500, RAM=8000)
