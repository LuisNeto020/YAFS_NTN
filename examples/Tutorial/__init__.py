...
from Tutorial import simplePlacement, simpleSelection, evolutivePopulationTopology, main1,main2,main3
...
toc = (
    ('simplePlacement'),
    ('simpleSelection'),
    ('Tuturial/evolutivePopulationTopology'),
    ('examples/Tuturial/main1'),
    ('Tuturial/main2'),
    ('Tuturial/main3'),
)
